...
public class FileStorageServiceImpl implements FileStorageService {
	...
	public String storeFile(MultipartFile file) {
		...
		try {
			...
			String imageFileId = fileStoreRepositoryObj.saveFileGridFs(targetLocation);

			loadFileAsResource(imageFileId);
	...
	public Resource loadFileAsResource(String imageFileId) throws IOException {
		String fileName=null;
		try {
			
			fileName=fileStoreRepositoryObj.retrieveImageFile(imageFileId);
